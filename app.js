...
function loadExample(){
  ...
  F('流理台',690,410,90); F('冰箱',700,640); T(690,560,'廚房',24);   // 開放式廚房，與客餐廳同一空間，不設門
  F('浴缸',830,390); F('馬桶',850,520); T(870,470,'衛浴',24);
  F('門',150,345,0,3); F('門',440,345,0,3); F('門',715,345,0,3);   // 三房門開向房內空地，不擋家具
  F('門',775,645,90,3); F('門',300,790,0,3);                        // 衛浴門開向客廳、前門
